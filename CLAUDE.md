...
>
> ⚠️ **หน้ายอดคงคลัง FG หักยอดที่เราส่งไปหลังนำเข้าไฟล์ออกจากยอดของ Delta** (เจ้าของเลือก 14 ก.ย. 2026 · `deltaWipLeft()`)
> นับยอดส่งที่วันที่ส่ง ≥ วันที่นำเข้าไฟล์ · ครอบที่ 0 · ใบที่ Delta ไม่ได้ให้ตัวเลขยังเป็น "ไม่มี"
> **หน้าใบส่งสินค้าและช่อง Wip bal. บนกระดาษไม่หัก** — ยังเป็นยอดของ Delta ตรง ๆ (วันเดียวกันเคยให้หักทุกที่ แล้วเจ้าของเปลี่ยนเป็นเฉพาะหน้า FG)
