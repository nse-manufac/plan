...
>
> ⚠️ **ยอดของ Delta หักยอดที่เราส่งไปหลังนำเข้าไฟล์** (เจ้าของสั่ง 14 ก.ย. 2026 · `deltaWipLeft()`) ใช้ทุกที่รวมหน้า FG
> นับยอดส่งที่วันที่ส่ง ≥ วันที่นำเข้าไฟล์ · บนใบส่งของเป็นยอด "ก่อนส่งใบนี้" · ครอบที่ 0
> ฐานยังเป็นยอดของ Delta เสมอ — ใบที่ Delta ไม่ได้ให้ตัวเลขยังเว้นว่าง ห้ามเอายอดค้างของเราไปแทน
