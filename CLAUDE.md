...
> `Wip bal.` หาจากหัวตารางแล้วตั้งแต่ #53 แต่ **`CALLIN_COL.qty` ยังยึด `'D'` อยู่**
> (ยังไม่แก้ ณ 5 ก.ย. 2026 — `fileQty` ใช้แค่ทำรายการเตือน ไม่ได้เก็บลงข้อมูล
> ผลคือแผงเทียบยอดขึ้น "PO QTY ไม่ตรง" มั่วเมื่ออ่านชีตแรก)
...
ชุดเทสตอนนี้มี **173 ข้อใน 7 ไฟล์** ครอบการคีย์ยอด · audit trail · วันที่ · ออฟไลน์ ·
