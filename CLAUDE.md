...
> เคยเขียน `saveDeltaWip` ให้ล้างยอดทั้งหน่วย แล้วใบ TUE-H ที่ปนอยู่ในชีตที่สองใบเดียว
...
> เก็บเป็น `wip: null` · ห้ามทิ้งแถว เพราะ "มีแถว" คือหลักฐานว่าใบนี้อยู่ในไฟล์รอบล่าสุด
...
ชุดเทสตอนนี้มี **165 ข้อใน 7 ไฟล์** ครอบการคีย์ยอด · audit trail · วันที่ · ออฟไลน์ ·
